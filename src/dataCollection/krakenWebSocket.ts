...
export class KrakenWebSocket {
    ...
    private connect(): WebSocket {
        console.log(`[WebSocket] Connecting to Kraken for ${this.symbols.length} symbols with ${this.intervalMinutes}min intervals...`);
        ...
        ws.onopen = () => {
            ...
            console.log(`[WebSocket] Subscribing to OHLC-${this.intervalMinutes} for ${this.symbols.length} symbols`);
    ...
    private handleDisconnect(): void {
        if (this.reconnectAttempts < this.maxReconnectAttempts) {
            ...
            console.log(`[WebSocket] Connection failed for ${this.symbols}. ` +
            ...
            console.error(`[WebSocket] Max reconnection attempts (${this.maxReconnectAttempts}) reached for ${this.symbols.length} symbols`);
